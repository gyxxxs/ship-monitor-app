...
"""
    ...
    try:
        ...
        # 处理工具调用
        final_response = handle_tool_calls(response, user_query, system_status, strategy, client)
...
def handle_tool_calls(response, user_query: str, system_status: dict, strategy: dict, client) -> str:
    """处理工具调用并生成智能回复"""
                    ...
                    if hasattr(part, 'function_call'):
                        ...
                        if tool_name in AVAILABLE_TOOLS:
                            ...
                            try:
                                ...
                                return enhance_final_response(tool_response.text, strategy, system_status)
